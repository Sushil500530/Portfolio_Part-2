...
const About = () => {
    return (
        <div id="about" className="w-full py-12 container mx-auto p-5">
            ...
            <hr className='w-40 border-b-2 border-fuchsia-500 mt-2' />
            <div className="flex flex-col lg:flex-row gap-5 w-full h-auto items-center pt-10">
                <div data-aos="fade-right" className='w-full md:w-[30%] lg:w-[40%] relative '>
                    <div className='w-[300px] md:w-[220px] lg:w-[300px] rounded-full mx-auto h-[300px] md:h-[220px] lg:h-[300px] border-4 hover:border-fuchsia-500 transition cursor-pointer border-[#7d5fff]'>
